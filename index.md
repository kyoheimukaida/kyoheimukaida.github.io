...
<section class="hero">
  <p class="eyebrow">Theoretical particle physics · Early-Universe cosmology</p>

  <h1>Kyohei Mukaida</h1>

  <p class="lead">
    I am a theoretical physicist working on particle physics and early-Universe cosmology,
    with a focus on reheating, thermalization, dark matter production, baryogenesis,
    primordial black holes, and cosmological collider physics.
  </p>

  <div class="button-row">
    <a class="button" href="research.html">Research</a>
    <a class="button" href="publications.html">Publications</a>
    <a class="button" href="talks.html">Invited Talks</a>
    <a class="button" href="cv.html">CV</a>
    <a class="button secondary" href="https://inspirehep.net/authors/1309535">INSPIRE</a>
  </div>
</section>
...
<article class="paper-card">
  <h3><a href="https://arxiv.org/abs/1312.3097">Thermalization after/during Reheating</a></h3>
  <p>JHEP 05, 006 (2014)</p>
</article>

<article class="paper-card">
  <h3><a href="https://arxiv.org/abs/1609.05209">Violent Preheating in Inflation with Nonminimal Coupling</a></h3>
  <p>JCAP 02, 045 (2017)</p>
</article>

<article class="paper-card">
  <h3><a href="https://arxiv.org/abs/1611.06130">Inflationary primordial black holes for LIGO and PTA observations</a></h3>
  <p>Phys. Rev. D 95, 123510 (2017)</p>
</article>

<article class="paper-card">
  <h3><a href="https://arxiv.org/abs/2011.09347">Wash-In Leptogenesis</a></h3>
  <p>Phys. Rev. Lett. 126, 201802 (2021)</p>
</article>
...
- **[Revisiting unitarity of single scalar field with non-minimal coupling](https://arxiv.org/abs/2603.06296)**  
  ...
  *arXiv preprint (2026-03-06)*  
  Summary: Using six-point scalar scattering amplitudes, this paper revisits the unitarity-violation scale of a quartic scalar field non-minimally coupled to gravity and compares the Jordan- and Einstein-frame descriptions. It finds frame-independent amplitudes and identifies the scalar potential, rather than target-space curvature from the conformal mode, as the relevant source in the single-field case.  
...
- **[Cancellation of loop corrections to soft scalar power spectrum](https://arxiv.org/abs/2603.01961)**  
  ...
  *arXiv preprint (2026-03-02)*  
  Summary: The authors show that enhanced short-wavelength scalar perturbations do not generate scale-invariant one-loop corrections to superhorizon curvature perturbations in the soft external-momentum limit, including in transient ultra-slow-roll inflation. The cancellation is traced to dilatation symmetry in the in-in effective theory for soft modes, with the tadpole counterterm respecting the same symmetry.  
...
For the full invited talk list, see [Invited Talks](talks.md).